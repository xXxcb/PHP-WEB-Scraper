...
import com.example.xander.fxconverter.R;
import com.example.xander.fxconverter.api.Tools;
    ...
    private void initComponent() {
        ...
        bt_retry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                Intent intent = new Intent(NoItemInternetImage.this, MainActivity.class);
